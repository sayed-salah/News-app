    ...
    public static ArrayList<News> extractResultFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < resultArray.length(); i++) {
                ...
                // JSONArray details = news.getJSONArray("tags");
                //  JSONObject authorname = details.getJSONObject(i);
                //  String firstname = authorname.getString("firstName");
                // String lastname = authorname.getString("lastName");
